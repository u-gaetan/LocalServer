const i18n = {
    fr: {
        ...
        tuto_etape0_titre: "Télécharger l'extension",
        tuto_etape0_texte: "Cliquez sur le bouton ci-dessous pour accéder au téléchargement de l'extension Chrome d'étude de navigation.",
        tuto_bouton_telecharger: "Lien pour télécharger l'extension",
        tuto_etape1_titre: "Installer l'extension",
        tuto_etape1_texte: "Cliquez sur le bouton pour installer l'extension dans votre navigateur.",
        tuto_etape1_5_titre: "Valider l'ajout de l'extension",
        tuto_etape1_5_texte: "Cliquez sur le bouton pour confirmer l'ajout de l'extension dans votre navigateur.",
    ...
    en: {
        ...
        tuto_etape0_titre: "Link for the extension",
        tuto_etape0_texte: "Click the button below to go on the download page of the Chrome extension dedicated to our web navigation research project.",
        tuto_bouton_telecharger: "Link to download the extension",
        tuto_etape1_titre: "Install the extension",
        tuto_etape1_texte: "Click on the button to install the extension in your browser.",
        tuto_etape1_5_titre: "Activate the extension",
        tuto_etape1_5_texte: "Click on the extension icon in your browser toolbar and then click on 'Activate'.",
